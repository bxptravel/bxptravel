  ...
  return (
    <div className="min-h-screen bg-bone font-body">
      ...
      <section className="max-w-6xl mx-auto px-6 sm:px-8 pb-10">
        ...
        <div className="bg-white border border-ink/10 rounded-2xl sm:rounded-full shadow-sm p-2 sm:p-2 sm:pr-2.5 max-w-4xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:flex-nowrap sm:items-center gap-1 sm:gap-0">
            ...
            {/* Guests */}
            <div className="flex items-center gap-1 bg-ink/[0.025] sm:bg-transparent rounded-xl sm:rounded-none px-3 py-2 sm:w-auto flex-shrink-0">
              <div className="flex-shrink-0">
                ...
                <input
                  ...
                  className="w-24 bg-transparent text-sm text-ink placeholder-muted outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                />
              </div>
